                ...
                <div class="d-flex flex-grow-1 justify-content-center">
                    @auth
                        <ul class="navbar-nav d-flex flex-row">
                            <li class="nav-item">
                                <a class="nav-link active fw-bold" aria-current="page" href="{{ route('event.index') }}">Event</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{ route('attendes.index') }}">Peserta</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{ route('tiket.index') }}">Tiket</a>
                            </li>
